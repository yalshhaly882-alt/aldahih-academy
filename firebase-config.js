...
export const DEFAULT_CONTENT = {
  ...
  welcomeTitle: "🚀 أهلاً بيك يا بطل في Al-Dahih Academy!",
  welcomeText: "🌟 هنا هتلاقي محاضرات نخبة مدرسين الثانوية العامة 2026 كاملة ومجانية بالكامل 🆓 من غير أي اشتراك ولا تعقيد. مذاكرة بجد دلوقتي = نتيجة تفتخر بيها بكرة 💪🔥 اختار اسمك وشعبتك وابدأ رحلتك 👇",
  supportUsername: "Al_Dahih11_Bot",
  groups: {
    scientific: { name: "علمي علوم", subjects: ["ara", "eng", "bio", "che", "phy", "fr", "ger"] },
    math:       { name: "علمي رياضة", subjects: ["ara", "eng", "math", "che", "phy", "fr", "ger"] },
    literary:   { name: "أدبي", subjects: ["ara", "eng", "geo", "his", "fr", "ger"] },
    azhar:      { name: "أزهر", subjects: ["ara", "eng", "bio", "che", "phy", "math", "fr", "ger"] }
  },
  subjectNames: {
